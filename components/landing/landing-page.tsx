...
const PLANS = [
  {
    ...
    price: "$0",
    period: "/ once",
    desc: "Try out generation features and see the magic.",
    tokens: "500 credits (once)",
    features: [
      "Generate full songs with vocals + instruments",
      "Generate music, Download songs - Limit (MP3)",
      "500 Credits (only once)"
    ],
    cta: "Start free",
    href: "/sign-up",
    featured: false,
  },
  {
    ...
    tokens: "3000 credits/ month",
    features: [
      "Generate full songs with vocals + instruments",
      "Generate instrumental-only music",
      "Download songs",
      "Stem Editor Basic",
      "AI Editor Album Generator",
  ...
  },
  {
    ...
    tokens: "5000 credits/ month",
    features: [
      "All features from Basic plan",
      "Download songs",
      "Album Generator (5 limit)",
      "Advanced AI Editor tools",
  ...
  },
  {
    ...
    price: "$16.99",
    period: "/ mo",
    desc: "Advanced features for serious music production.",
    tokens: "10000 credits/ month",
    features: [
      "All features from Plus plan",
      "Download songs",
      "Album Generator (No limit)",
      "Image to Song",
      "Advanced AI Editor tools",
      "Commercial Usage",
