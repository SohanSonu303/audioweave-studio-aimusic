...
export function AnnouncementBanner() {
  ...
  return (
    <div className="px-7 py-3 border-b border-[color:var(--aw-border)] flex-shrink-0 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuGroup>
              <DropdownMenuItem className="text-[13px] gap-2 cursor-pointer focus:bg-[rgba(255,255,255,0.06)] focus:text-[color:var(--aw-text)]">
